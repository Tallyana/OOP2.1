...
public class Flowers {
    ...
    public Flowers(String flowerName,double cost, int lifeSpan){
    ...
    public Flowers(String flowerName, String country, double cost){
        if(flowerName == null || flowerName.isEmpty())
            this.flowerName = "Белый"; else this.flowerName = flowerName;
        if(country == null || country.isEmpty()) this.country = "Россия"; else this.country = country;
        if(cost <= 0.0) this.cost = 1.0; else this.cost = cost;
        this.lifeSpan = 3;
    }
    public Flowers(String flowerName, String country, double cost, int lifeSpan){
        if(flowerName == null || flowerName.isEmpty()) this.flowerName = "Белый";
        else this.flowerName = flowerName;
